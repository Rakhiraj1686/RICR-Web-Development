      ...
      <div className="fixed inset-0 bg-black/50 flex justify-center items-center">
        <div className="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg shadow-lg">
          <div className="flex justify-between px-6 py-4 border-b border-(--color-border) items-center sticky top-0 bg-white">
            ...
            <button
              onClick={() => onClose()}
              className="text-(--color-text-secondary) hover:text-(--color-primary) text-2xl transition"
            >
              ⊗
            </button>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-(--color-border) rounded-md shadow-sm p-2 disabled:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-(--color-primary)"
