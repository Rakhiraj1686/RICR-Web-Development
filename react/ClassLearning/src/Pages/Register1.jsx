...
const Register1 = () => {
  return (
    ...
    <div className="flex justify-center p-3 ">
      <h1 className="text-4xl text-blue-700 font-bold mt-5">Student Registation Form</h1>
    </div>
      <div className="m-10 p-5 shadow border text-black rounded-2xl">
        <div>
          <div className=" rounded shadow mx-3 pt-5 mt-3 pb-2">
            <span className="px-2 text-blue-500 ">Personal Information</span>
            ...
            <div className="mx-2 flex gap-4 pt-3 ">
              ...
              <input
                ...
                name="fullName"
                id="fullName"
                className="border border-gray-300 rounded shadow-2xs w-7xl focus:ring focus:border-blue-700"
              />
            </div>
            <div className="mx-2 flex gap-4 pt-3 ">
        ...
        <div className=" rounded shadow p-3 pt-5 mx-3 mt-3">
        ...
        {/* course Information */}
        <div className=" rounded shadow p-3 mx-3 pt-5 mt-3">
        ...
        {/* Address */}
        <div className=" rounded mx-3 shadow p-3 pt-5 mt-3">
        ...
        <div className="text-center p-3 mt-2">
          <button
            className="border px-5 pt-2 py-2 rounded-xl bg-blue-600 text-white shadow"
            type="submit"
          >
            Sumbit
          </button>
